...
ax.grid()
ax.legend(loc='lower right')
plt.savefig("../results/plots/ced/wall1_ced_all.svg", format='svg')
plt.close()
...
ax.grid()
ax.legend(loc='lower right')
plt.savefig("../results/plots/ced/wall2_ced_all.svg", format='svg')
plt.close()
...
ax.grid()
ax.legend(loc='lower right')
plt.savefig("../results/plots/ced/wall3_ced_all.svg", format='svg')
plt.close()